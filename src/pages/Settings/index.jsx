                ...
                <div className="form-group">
                  ...
                  <div className="hour-days-wrap">
                    <input
                      ...
                      placeholder="Hours"
                    />
                    <CustomSelet className='select' options={durationOption}
                      onChange={(e) => handleChange(e.target.value, 'deadLineIntrvl')} />
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className="hour-days-wrap">
                    <input
                      type="text"
                      className="form-control"
                      onChange={(e) => handleChange(e.target.value, 'ezDeadline')}
                      placeholder="Hours"
                    />
                    <CustomSelet className='select' options={durationOption}
                      onChange={(e) => handleChange(e.target.value, 'ezDeadlineIntrvl')} />
                  </div>
                ...
                <div className="form-group form-group-last">
                  ...
                  <div className="form-switch">
                    <input
                      ...
                      onChange={() => handleChange(!form.notification, 'notification')}
                    />
                    <label
