...
export default function AddEditAppointmentSettingsModal({ showModal, closeModal, onRefreshAppointmentSettings }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
                ...
                <div className="col-sm-6">
                    <div className="form-group forms-custom">
                        <label htmlFor="name" className="label">
                            Appointment Settings Name<span className="text-danger">*</span>
                        </label>
                        <input
                            type="text"
                            id="name"
                            ...
                            autoComplete="off"
                            maxLength={20}
                            placeholder="Enter appointment settings name"
                            {...register('name')}
                        />
                        {errors.name && (
